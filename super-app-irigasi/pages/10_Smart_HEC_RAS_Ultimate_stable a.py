    ...
    with active_tabs[idx]:
        ...
        with rt_cs:
            ...
            if len(all_nodes_new) > 0:
                # --- MODIFIKASI: SLIDER BERBASIS SEGMEN ---
